    ...
    add_action( 'acf/init', function() {
        acf_add_local_field_group( array(
            ...
            'fields' => array(
                ...
                array(
                    'key' => 'field_cap_related_blog_clone_content',
                    'label' => 'Related Blog Content',
                    'name' => 'cap_related_blog_content',
                    'type' => 'clone',
                    'clone' => array(
                ...
                array(
                    'key' => 'field_cap_related_blog_clone_design',
                    'label' => 'Related Blog Design',
                    'name' => 'cap_related_blog_design',
                    'type' => 'clone',
                    'clone' => array(
                ...
                array(
                    'key' => 'field_cap_related_blog_clone_settings',
                    'label' => 'Related Blog Settings',
                    'name' => 'cap_related_blog_settings',
                    'type' => 'clone',
                    'clone' => array(
