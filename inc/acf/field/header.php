	...
	add_action( 'acf/init', function() {
		acf_add_local_field_group( array(
			...
			'fields' => array(
				...
				array(
					'key'   => 'field_header_industry_tab',
					'label' => 'Industry',
					'type'  => 'tab',
				),
				array(
					'key'     => 'field_header_industry_parent_link',
					'label'   => 'Parent Link (All Industries)',
					'name'    => 'header_industry_link',
					'type'    => 'link',
					'wrapper' => array( 'width' => '100' ),
				),
				array(
					'key'          => 'field_header_industry_items',
					'label'        => 'Industry Items',
					'name'         => 'header_industry_items',
					'type'         => 'repeater',
					'layout'       => 'block',
					'collapsed'    => 'field_header_industry_item_title',
					'button_label' => 'Add Industry',
					'sub_fields'   => array(
						array(
							'key'     => 'field_header_industry_item_title',
							'label'   => 'Title',
							'name'    => 'title',
							'type'    => 'text',
						...
						array(
							'key'     => 'field_header_industry_item_link',
							'label'   => 'Link',
							'name'    => 'link',
							'type'    => 'link',
							'wrapper' => array( 'width' => '35' ),
						...
						array(
							'key'           => 'field_header_industry_item_icon',
							'label'         => 'Icon',
							'name'          => 'icon',
							'type'          => 'textarea',
							'instructions'  => '直接粘贴 SVG 代码（从 <svg ...> 开始，到 </svg> 结束）。',
							'new_lines'     => '',
							'rows'          => 6,
							'wrapper'       => array( 'width' => '100' ),
						),
				...
				array(
					'key'   => 'field_header_resources_tab',
					'label' => 'Resources',
					'type'  => 'tab',
				),
				array(
					'key'     => 'field_header_resources_parent_link',
					'label'   => 'Parent Link (All Resources)',
					'name'    => 'header_resources_link',
					'type'    => 'link',
					'wrapper' => array( 'width' => '100' ),
				),
				array(
					'key'          => 'field_header_resources_items',
					'label'        => 'Resource Items',
					'name'         => 'header_resources_items',
					'type'         => 'repeater',
					'layout'       => 'block',
					'collapsed'    => 'field_header_resources_item_title',
					'button_label' => 'Add Resource',
					'sub_fields'   => array(
						array(
							'key'     => 'field_header_resources_item_title',
							'label'   => 'Title',
							'name'    => 'title',
							'type'    => 'text',
							'wrapper' => array( 'width' => '35' ),
						...
						array(
							'key'     => 'field_header_resources_item_link',
							'label'   => 'Link',
							'name'    => 'link',
							'type'    => 'link',
							'wrapper' => array( 'width' => '35' ),
						...
						array(
							'key'           => 'field_header_resources_item_icon',
							'label'         => 'Icon',
							'name'          => 'icon',
							'type'          => 'textarea',
							'instructions'  => '直接粘贴 SVG 代码（从 <svg ...> 开始，到 </svg> 结束）。',
