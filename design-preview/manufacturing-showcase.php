        ...
        acf_add_local_field_group( array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'required' => 0,
                    'default_value' => 'Manufacturing Showcase',
                    'wrapper' => array(
                        'width' => '100',
                    ),
                ),

                // Gallery: Showcase Items (Replaces Repeater)
                array(
                    'key' => 'field_mfs_gallery',
                    'label' => 'Showcase Images',
                    'name' => 'manufacturing_showcase_gallery',
                    'type' => 'gallery',
                    'instructions' => '批量上传或选择展示图片。推荐尺寸：800x600px (4:3 比例)。',
                    'return_format' => 'id',
                    'preview_size' => 'medium',
                    'insert' => 'append',
                    'library' => 'all',
